    ...
    <div className="w-full h-screen h-[100dvh] max-h-[100dvh] bg-transparent text-white font-sans flex flex-col overflow-hidden select-none relative">
      ...
      <div className="flex flex-1 overflow-hidden p-0 md:p-2 gap-2 z-10 relative">
        ...
        <main className="flex-1 bg-[#0a0a14]/40 backdrop-blur-md rounded-none md:rounded-lg relative overflow-hidden flex flex-col border-0 md:border md:border-white/5 shadow-2xl w-full">
          ...
          <header className="flex items-center justify-between px-2.5 sm:px-4 py-2.5 sm:py-4 pt-safe sticky top-0 z-20 bg-[#0a0a14]/80 backdrop-blur-md border-b border-white/5 shrink-0 gap-2 sm:gap-4">
